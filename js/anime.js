const shows = [
    ...
    },
    {
        ...
        desc: `Vagabond is my favourite manga of all time. Everything is perfect: from the story, to the art, to the characters, to the character development, and even the "ending." 
    ...
    },
    {
        ...
        desc: `Code Geass is truly a master-piece. It rivals Death Note - being even better in my opionion: beautiful art with vibrant colours, an interesting story packed with strategic action, 
                ...
                I'll ever get over just how good the first opening is either. Theres too much to say and not enough words to say it all in, so I'll just say this: Code Geass is phenomenal through and through.`,
    },
];
